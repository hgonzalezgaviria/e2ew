		...
		<div class="navbar-header">
			...
			<ul class="nav navbar-nav">
				...
				<li>
					...
					<a href="javascript:myModalEstado('/services/Clientes/panel.php');">Estados </a>					
					<!--a data-toggle="modal" data-target="#fsModal">Estados-->
					...
					echo "<li class='dropdown'>";
		 			echo "<a class='dropdown-toggle' data-toggle='dropdown' href='#'>Logs";
		 				...
		 				echo "<ul class='dropdown-menu'>";
							...
							echo "<li><a href=javascript:myModal('/services/logs/');>Files</a></li>";
