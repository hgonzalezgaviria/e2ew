					...
					echo "<div class='panel panel-default'>";
						...
						echo "<table class='table'>";
							...
							echo "<tbody>";
								...
								echo "<td>HB</td>";
								echo "<td>";
								if(statusPing(getUrlIp($ipPrivada,1,6))=="Activo"){
								echo "<img src='../img/ok.png' border='0' width='20' height='20'>";
								}elseif(statusPing(getUrlIp($ipPrivada,1,6))=="Inactivo"){
								echo "<img src='../img/nok.png' border='0' width='20' height='20'>";
								}else{
									echo "<img src='../img/nok.png' border='0' width='20' height='20'>";
								}
								echo "</td>";
								 echo "<td>";
								 if(statusEAI(getUrlIp($ipPrivada,2,6))=="Activo"){
									echo "<img src='../img/ok.png' border='0' width='20' height='20'>";
									}elseif(statusEAI(getUrlIp($ipPrivada,2,6))=="Inactivo"){
									echo "<img src='../img/nok.png' border='0' width='20' height='20'>";
									}
									else{
									echo "<img src='../img/nok.png' border='0' width='20' height='20'>";
								...
								echo "</td>";
								echo "<td><a href=javascript:myModal('http://".$ipPublica.":8080/HOMEBANKING/servlet/State');><span data-toggle='tooltip' title='HB STATUS' class='glyphicon glyphicon-link'></span></a></td>";
								echo "</tr>";//fin HB
								echo "<tr> <th scope='row'></th>";
								echo "<td>BANCO</td>";
								echo "<td>";
								if(statusPing(getUrlIp($ipPrivada,1,7))=="Activo"){
								echo "<img src='../img/ok.png' border='0' width='20' height='20'>";
								}elseif(statusPing(getUrlIp($ipPrivada,1,7))=="Inactivo"){
								echo "<img src='../img/nok.png' border='0' width='20' height='20'>";
								}else{
									echo "<img src='../img/nok.png' border='0' width='20' height='20'>";
								}
								echo "</td>";
								 echo "<td>";
								 if(statusEAI(getUrlIp($ipPrivada,2,7))=="Activo"){
									echo "<img src='../img/ok.png' border='0' width='20' height='20'>";
									}elseif(statusEAI(getUrlIp($ipPrivada,2,7))=="Inactivo"){
									echo "<img src='../img/nok.png' border='0' width='20' height='20'>";
									}
									else{
									echo "<img src='../img/nok.png' border='0' width='20' height='20'>";
								...
								echo "</td>";
								echo "<td><a href=javascript:myModal('http://".$ipPublica.":8080/E2FBANCO/servlet/State');><span data-toggle='tooltip' title='BANCO STATUS' class='glyphicon glyphicon-link'></span></a></td>";
								echo "</tr>";//fin BANCO
							echo " </tbody>";
						echo "</table>";
					echo "</div>";
